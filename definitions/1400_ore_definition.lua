...
---@class mt.OreDef
---
---@field ore_type mt.OreType Supported: "scatter", "sheet", "puff", "blob", "vein", "stratum"
---@field ore string Ore node to place
---@field ore_param2 number? Param2 to set for ore (e.g. facedir rotation)
---@field wherein string|string[] Node to place ore in. Multiple are possible by passing a list.
...
---@field flags mt.OreFlags? Attributes for the ore generation, see 'Ore attributes'
